...
<html lang="en">
    <head>
        ...
        –––––––––––––––––––––––––––––––––––––––––––––––––– -->
        <meta charset="utf-8">
        <title>Introducing Evergreen Wellness</title>
    ...
    <body>
        ...
        <div class="container">
            ...
            <!--logo-->
            <div id="logo" class="townHallLogo">
                <div class="row">
                    <div class="townHallLogoContainer">
                      <img id="ipad-logo" src="images/EvergreenWellnessLogoPhone.png">
                    </div>
                </div>
            </div>
            <!--/logo-->
            ...
            <!--greenDiv-->
            <div id="greenDivSmall">
                <div id="greenDiv" class="row greenDivIpad"></div>
            </div>
            <!--/greenDiv-->

            <!--greenDiv-->
            <div id="greenDivLargeOnly">
                <div id="greenDiv" class="row greenDivTownHall"></div>
            </div>
            <!--/greenDiv-->

            <div id="orangeDivIpad">
                <div id="orangeDiv" class="row bevelBox orangeDivIpad">
                    <div id="SignUp" class="row">
                        <h2 class="hide">Sign Up</h2>
                        <img id="arrow" src="images/arrowPhone.png">
                    </div>
                    <script type="text/javascript" src="https://marketingincolor.formstack.com/forms/js.php/new_ipad_form"></script><noscript><a href="https://marketingincolor.formstack.com/forms/new_ipad_form" title="Online Form">Online Form - EGW - iPad</a></noscript>
                    <div style="text-align:right; font-size:x-small;"><a href="http://www.formstack.com?utm_source=jsembed&utm_medium=product&utm_campaign=product+branding&fa=h,2369229" title="Online Form Builder">Online Form Builder</a>
                    </div>
                </div>
            </div>
