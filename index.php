...
<html lang="en">
    ...
    <body>
        ...
        <!--logo-->
        <div id="logo" class="town-hall-logo row">
        ...
        <div class="contain-to-grid" id="greenDiv">
            <div class = "row">
                <div class="small-12 medium-6 columns large-7 text-center"><h1>Complete this form to be notified when our website goes live.</h1></div>
                <div class="small-12 medium-6 clear large-7 float-left columns text-center"><p>You'll also be the first to receive updates on the latest special events and offers. We are your resource to get informed, get inspired, and get healthy - it's free!</p></div>
            </div>
        </div>
        <!--/greenbar-->
        ...
        <!---orangeDiv--->
        <div class="index-orange small-12 medium-6 large-6 large-offset-1 columns small-centered">
            <div id="orangeDiv" class="orange-bg">
                <div class="row">
                    <div class ="small-12 columns">
                        <div id="SignUp" class="row text-center">
                            <div class="small-8 columns text-right"><h2>Learn More</h2></div>
                            <div class="small-4 columns text-left"><img id="arrow" src="images/arrowPhone.png"></div>
                        </div>
                        <div class="row">
                            <div class="small-12 columns small-centered">
                                <script type="text/javascript" src="https://marketingincolor.formstack.com/forms/js.php/untitled_form_14"></script><noscript><a href="https://marketingincolor.formstack.com/forms/untitled_form_14" title="Online Form">Online Form - EGW Landing Page</a></noscript>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <!--footer-->
        <?php include ('alt-index-footer.php');?>
        <!--/footer-->
        ...
        <script type="text/javascript">
          ...
          __ss_noform.push(['endpoint', '7d1dbbe3-9fa3-4733-8a69-1d6dd66a709d']);
        </script>
